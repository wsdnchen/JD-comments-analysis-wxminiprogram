...
def data_virtualization(itemUrl):
    '''分析结果可视化，以条形图为测试样例'''
    font = FontProperties(fname='/System/Library/Fonts/Supplemental/Songti.ttc', size=14)  #改前fnmae=WC_FONT_PATH
    ...
    print("情感分析直方图已覆盖至../src/main/resources/static/" + itemId + "JD.jpg")
